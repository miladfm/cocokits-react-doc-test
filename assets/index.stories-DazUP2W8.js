import{j as t}from"./doc-page-BxZKXuST.js";import{ag as o}from"./chunk-NUUEMKO5-s6z9Pfb4.js";import"./mdx-page-with-theme-section-DOp5Uwfh.js";import{r as s,w as l,t as c,c as p,s as m,j as a}from"./control.config-CV_xzXa5.js";import"./index-qVDZzPEr.js";import{r as d}from"./preview.base-Bdj123Qn.js";import"./react-18-CVVedRj1.js";import"./index-DM35cTar.js";import"./iframe-Bj4MtXn0.js";import"../sb-preview/runtime.js";import"./index-D2o5vtt7.js";import"./index-DrFu-skq.js";import"./addon.model-Bsae6IwI.js";const u=`The \`SvgIcon\` from \`@cocokits\` allows for the dynamic embedding of SVG icons within your Angular applications.\r
\r
\r
#### Features:\r
\r
...
- **Theme Integration:** Select an SVG icon from your theme, and the component handles the rest, ensuring it aligns perfectly with your application's look and feel.`,j={name:"Default",parameters:{docs:{description:{story:"Shows the default example with no additional configurations, providing an interactive example in its most basic form."}},cckAddon:{renderConditions:[s("Overview")],source:[{filename:"Source Code",language:"tsx",code:`
            <SvgIcon
              ...
              icon={YOUR_ICON}
            />
          `}],hasControl:!0,controls:[l("heartFill"),c(),p(),m()]}},render:e=>o.jsx(t,{...d(e),icon:e.cckIcons[e.cckControl.icon]})},O={name:"Size",parameters:{docs:{description:{story:"The size is adjustable to suit different design needs and screen dimensions, improving both aesthetics and usability."}},cckAddon:{renderConditions:[a("size"),s("Overview")],singleControls:["type"],source:[{filename:"Source Code",language:"tsx",code:`
...
`)}},cckAddon:{componentName:"svgIcon"}}},A=["Default","Size","Color"];export{T as Color,j as Default,O as Size,A as __namedExportsOrder,F as default};
