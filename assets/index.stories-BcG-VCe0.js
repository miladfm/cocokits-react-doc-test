import{B as n,j as a,N as e,I as m,P as r,Q as l}from"./doc-page-B8-7hsnq.js";import{ag as o}from"./chunk-NUUEMKO5-DfU8yETC.js";import"./mdx-page-with-theme-section-Ds6tA5ZE.js";import{r as s,o as k,E as A,F as E,t as d,c as h,s as b,a as I,d as T,j as u}from"./control.config-Cd9IPF8Y.js";import"./index-qVDZzPEr.js";import{r as v}from"./preview.base-12sOgnxx.js";import"./react-18-CVVedRj1.js";import"./index-DM35cTar.js";import"./menu-item-COnSJPk_.js";import"./toggle-Bq0O4mPh.js";import"./iframe-BZzLEKjQ.js";import"../sb-preview/runtime.js";import"./index-D2o5vtt7.js";import"./index-DrFu-skq.js";import"./addon.model-Bsae6IwI.js";const z=`
...
`,w={info:z,trash:j},H="A button in the context of UI is an interactive element that allows users to perform an action.\r\n\r\nThe `Button` from `@cocokits` provides a flexible, customizable button element within React applications. This component is compatible with multiple design system themes and allows for various configurations, including different button types, colors, and sizes.\r\n",ht={name:"Default",parameters:{docs:{description:{story:"Shows the default example with no additional configurations, providing an interactive example in its most basic form."}},cckAddon:{source:[{filename:"Source Code",language:"tsx",code:`
          ...
          `}],renderConditions:[s("Overview")],hasControl:!0,controls:[k("Button"),A("heartFill"),E("none"),d(),h(),b(),I(),T()]}},args:{},render:t=>o.jsxs(n,{...v(t),disabled:t.cckControl.disabled,children:[t.cckControl.leftIcon!=="none"&&o.jsx(a,{icon:t.cckIcons[t.cckControl.leftIcon]}),t.cckControl.text,t.cckControl.rightIcon!=="none"&&o.jsx(a,{icon:t.cckIcons[t.cckControl.rightIcon]})]})},bt={name:"Type",parameters:{docs:{description:{story:"Displays variations in appearance and functionality, demonstrating how different types can be used to create unique button styles."}},cckAddon:{renderConditions:[u("type"),s("Overview")],source:[{filename:"Source Code",language:"tsx",code:`
          ...
          `}],controls:[d()]}},render:t=>{var c;return o.jsx(o.Fragment,{children:(c=t.cckControl.themeComponentConfig.color)==null?void 0:c.values.map((i,p)=>o.jsx(n,{type:t.cckControl.type,color:i,children:i},p))})}},M={[e.FramesX]:{},[e.CocoKits]:{}},V={[e.FramesX]:{},[e.CocoKits]:{}},$=[{language:"tsx",filename:"BackButton.tsx",code:`
