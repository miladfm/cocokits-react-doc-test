...
`}];function Ke(e){return t.jsxs(C,{children:[t.jsx(F,{children:"Enter username"}),t.jsx(N,{children:t.jsx(x,{icon:w.user})}),t.jsx(T,{})]})}Ke.__docgenInfo={description:"",methods:[],displayName:"LeadingIcon",props:{cckExampleArgs:{required:!0,tsType:{name:"ExampleArgs"},description:""}}};const Uo={name:"Leading Icon",parameters:{cckAddon:{renderConditions:[I("Examples")],source:rn,exampleStory:{templateArgsMap:nn,cssArgsMap:on}}},render:e=>t.jsx(an,{styles:e.cckExampleCssVariables,children:t.jsx(Ke,{cckExampleArgs:e.cckExampleArgs})})},an=h.div`
  ${({styles:e})=>L`
    ${e}
  `}
