...
:root {
  ...
  `;return i(s)}function b(t){const o=t.id==="frames-x"?".cck-theme-frames-x__color-mode--light":".cck-theme-cocokits__brand-color-1--light",s=t.id==="frames-x"?".cck-theme-frames-x__color-mode--dark":".cck-theme-cocokits__brand-color-1--dark";return`
...
:root {
  ...
  `;return i(f)}function S(){return i(`html
...
You can choose to install only the components you need.`]}),e.jsxs(o.p,{children:["In this example, we'll install only the ",e.jsx(o.code,{children:"Button"})," and ",e.jsx(o.code,{children:"Radio"})," components."]}),e.jsx(o.h3,{id:"step-1-install-the-components",children:"Step 1: Install the Components"}),e.jsx(o.p,{children:"Install the specific components and the theme:"}),e.jsx(n,{fn:s=>e.jsx(h,{codeTabs:{npm:`npm i @cocokits/react-button @cocokits/react-radio @cocokits/theme-${s.id}`,yarn:`yarn add @cocokits/react-button @cocokits/react-radio @cocokits/theme-${s.id}`,pnpm:`pnpm add @cocokits/react-button @cocokits/react-radio @cocokits/theme-${s.id}`}})}),e.jsx(o.h3,{id:"step-2-provide-theme-configuration",children:"Step 2: Provide Theme Configuration"}),e.jsx(n,{fn:s=>`Provide the ${a(s.displayName)} theme configuration in the root of your application.`}),e.jsx(o.p,{children:e.jsx(o.strong,{children:"App.tsx"})}),e.jsx(n,{fn:s=>i(`tsx
...
export default App;
`)}),e.jsx(o.h3,{id:"step-3-import-tokens-and-component-styles",children:"Step 3: Import Tokens and Component Styles"}),e.jsx(o.p,{children:"Instead of importing all styles, you can import only the necessary tokens and styles for the components you're using."}),e.jsx(n,{fn:s=>i(`scss
@use "@cocokits/theme-${s.id}/tokens.min.css";
@use "@cocokits/theme-${s.id}/styles-core" as ${c(s.displayName)};

@include ${c(s.displayName)}.components_button;
@include ${c(s.displayName)}.components_icon_button;
@include ${c(s.displayName)}.components_radio_button;
@include ${c(s.displayName)}.components_radio_group;

// Other global styles
`)}),e.jsx(o.hr,{}),e.jsx(o.h2,{id:"override-theme-ui-configurations",children:"Override Theme UI Configurations"}),e.jsxs(o.p,{children:["You can customize the default configuration of the theme. For example, to change the default size of the ",e.jsx(o.code,{children:"Button"})," component from ",e.jsx(o.code,{children:"xs"}),":"]}),e.jsx(n,{fn:s=>i(`tsx
...
export default App;
`)}),e.jsxs(o.p,{children:[e.jsx(o.strong,{children:"Important:"})," If you change the configuration of a component (e.g., adding a new size or color), make sure you include the corresponding styles. Otherwise, the new configuration may not be reflected in your application."]}),e.jsx(o.hr,{}),e.jsx(o.h2,{id:"merge-themes",children:"Merge Themes"}),e.jsxs(o.p,{children:["You can also merge multi themes and create a new theme. For example, you want to have the ",e.jsx(o.code,{children:"Cocokits"})," theme but ",e.jsx(o.code,{children:"button"}),", ",e.jsx(o.code,{children:"radio"})," be from ",e.jsx(o.code,{children:"Frames X"})]}),e.jsx(o.h3,{id:"step-1-install-the-themes",children:"Step 1: Install the Themes"}),e.jsx(h,{codeTabs:{npm:"npm i @cocokits/react-components @cocokits/theme-frames-x @cocokits/theme-cocokits",yarn:"yarn add @cocokits/react-components @cocokits/theme-frames-x @cocokits/theme-cocokits",pnpm:"pnpm add @cocokits/react-components @cocokits/theme-frames-x @cocokits/theme-cocokits"}}),e.jsx(o.h3,{id:"step-2-merge-the-theme-configurations",children:"Step 2: Merge the Theme Configurations"}),e.jsx(n,{fn:s=>i(`tsx
...
export default App;
`)}),e.jsx(o.h3,{id:"step-3-import-component-styles-from-each-theme",children:"Step 3: Import Component Styles from Each Theme"}),e.jsxs(o.p,{children:["In your ",e.jsx(o.code,{children:"styles.scss"}),", include styles from both themes:"]}),e.jsx(o.p,{children:e.jsx(o.strong,{children:"styles.scss"})}),e.jsx(n,{fn:M}),e.jsx(o.hr,{}),e.jsx(o.h2,{id:"use-only-one-mode-from-each-collection",children:"Use Only One Mode from Each Collection"}),e.jsx(o.p,{children:`Each theme provides multiple modes for each collection (e.g., color, sizing). If your project requires only one mode per collection,\r
...
`})}),e.jsx(o.p,{children:"If you prefer shorter or custom selector names, you can redefine them using the provided SCSS mixins."}),e.jsx(o.h3,{id:"example-shorten-color-mode-selectors",children:"Example: Shorten Color Mode Selectors"}),e.jsx(o.p,{children:"Let's change the color mode selectors from:"}),e.jsx(n,{fn:b}),e.jsx(o.h4,{id:"step-1-define-custom-selectors",children:"Step 1: Define Custom Selectors"}),e.jsx(o.p,{children:e.jsx(o.strong,{children:"styles.scss"})}),e.jsx(n,{fn:$}),e.jsx(o.h4,{id:"step-2-apply-custom-selectors",children:"Step 2: Apply Custom Selectors"}),e.jsx(o.p,{children:e.jsx(o.strong,{children:"index.html"})}),e.jsx(n,{fn:S}),e.jsxs(o.p,{children:[e.jsx(o.strong,{children:"Note:"})," This approach allows you to switch between light and dark modes using shorter class names."]})]})]})}function z(t={}){const{wrapper:o}={...u(),...t.components};return o?e.jsx(o,{...t,children:e.jsx(p,{...t})}):p(t)}export{z as default};
