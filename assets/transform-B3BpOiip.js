import{ag as e,ah as l}from"./chunk-NUUEMKO5-LLHHQr8R.js";import{useMDXComponents as s}from"./index-DOvxcyG1.js";import{M as a}from"./mdx-page-with-theme-section-DmqQ5M3U.js";import"./index-qVDZzPEr.js";import"./doc-page-DZtkdTH4.js";import"./react-18-CVVedRj1.js";import"./index-DM35cTar.js";import"./iframe-C3BREnma.js";import"../sb-preview/runtime.js";import"./index-D2o5vtt7.js";import"./index-DrFu-skq.js";const i=[{id:"selection_toarray",name:"toArray()"},{id:"selection_tobooleanorpresent",name:"toBooleanOrPresent()"},{id:"selection_tonumber",name:"toNumber()"}];function t(n){const r={code:"code",h2:"h2",h3:"h3",hr:"hr",p:"p",pre:"pre",...s(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(l,{title:"Utils/Transform"}),`
...
If the input is `,e.jsx(r.code,{children:"null"})," or ",e.jsx(r.code,{children:"undefined"}),", it returns an empty array."]}),e.jsx(r.h3,{id:"type-parameters",children:"Type Parameters"}),e.jsxs("table",{class:"arg-type-table arg-type-table--full-width",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Type Parameter"}),e.jsx("th",{children:"Description"})]})}),e.jsx("tbody",{children:e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(r.p,{children:e.jsx(r.code,{children:"T"})})}),e.jsx("td",{children:e.jsx(r.p,{children:"The type of the input value."})})]})})]}),e.jsx(r.h3,{id:"parameters",children:"Parameters"}),e.jsxs("table",{class:"arg-type-table arg-type-table--full-width",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Parameter"}),e.jsx("th",{children:"Type"}),e.jsx("th",{children:"Description"})]})}),e.jsx("tbody",{children:e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(r.p,{children:e.jsx(r.code,{children:"value"})})}),e.jsx("td",{children:e.jsx(r.p,{children:e.jsx(r.code,{children:"T | T[]"})})}),e.jsx("td",{children:e.jsxs(r.p,{children:["The value to be converted into an array. It can be a single value, an array, or ",e.jsx(r.code,{children:"null"}),"/",e.jsx(r.code,{children:"undefined"}),"."]})})]})})]}),e.jsx(r.h3,{id:"returns",children:"Returns"}),e.jsx(r.p,{children:e.jsx(r.code,{children:"T[]"})}),e.jsx(r.p,{children:"An array containing the input value, the input array as-is, or an empty array if the input is nullish."}),e.jsx(r.pre,{children:e.jsx(r.code,{className:"language-typescript",children:`console.log(toArray(42)); // Outputs: [42]\r
