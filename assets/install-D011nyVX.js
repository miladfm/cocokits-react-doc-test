import{ag as e,ah as u}from"./chunk-NUUEMKO5-Dz559y2o.js";import{useMDXComponents as p}from"./index-DOvxcyG1.js";import{M as x,a as s,b as g}from"./mdx-page-with-theme-section-CIBIxBgl.js";import"./index-qVDZzPEr.js";import{l as d}from"./doc-page-DBjR3k1M.js";import"./react-18-CVVedRj1.js";import"./index-DM35cTar.js";import{c,b as r}from"./markdown.util-CPD1LGoI.js";import"./iframe-BGBlGzCY.js";import"../sb-preview/runtime.js";import"./index-D2o5vtt7.js";import"./index-DrFu-skq.js";const j=[{id:"step-1-install-packages",name:"Step 1"},{id:"step-2-provide-theme-configuration",name:"Step 2"},{id:"step-3-add-component-styles",name:"Step 3"},{id:"step-4-apply-theme-modes",name:"Step 4"},{id:"step-5-basic-usage-of-components",name:"Step 5"},{id:"step-6-use-tokens-in-your-component-styles",name:"Step 6"}];function f(t){const o=`typescript
...
<html class="${Object.entries(t.selectedModes).map(([a,i])=>`cck-theme-${t.id}__${a}--${i}`).join(" ")}">
...
</html>
  `;return c(n)}function b(t){const n=`html
<html data-cck-theme="${Object.entries(t.selectedModes).map(([a,i])=>`${t.id}__${a}--${i}`).join(" ")}">
...
</html>
  `;return c(n)}function M(t){const o=t.id==="frames-x"?"sizing":"brand-color-1",n=t.selectedModes[o];return`
For example, to set the ${r(n)} mode from ${r(o)}:
  - **Collection Name:** ${r(o)}
  - **Mode Name:** ${r(n)}
  - **CSS Class:** ${r(`cck-theme-${t.id}__${o}--${n}`)}
    `}function m(t){return e.jsx("table",{className:"collection-modes-selector-table",children:e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("th",{children:"Collection Name"}),e.jsx("th",{children:"Mode Names"}),e.jsx("th",{children:"Selectors"})]}),Object.entries(t.tokenDictionary.collectionModeNames).map(([n,a])=>a.map((i,h)=>e.jsxs("tr",{children:[h===0&&e.jsx("td",{rowSpan:a.length,className:"collection-modes-selector-table__header-cell",children:n}),e.jsx("td",{children:i.name}),e.jsx("td",{children:e.jsxs("ul",{children:[e.jsx("li",{children:e.jsxs("code",{children:[".cck-theme-",t.id,"__",n,"--",i.name]})}),e.jsx("li",{children:e.jsxs("code",{children:["[data-cck-theme*='",t.id,"__",n,"--",i.name,"']"]})})]})})]})))]})})}function T(){return c(`typescript
...
It includes information on prerequisites, installation, and how to display a sample component in your application to verify your setup.`]}),e.jsx(o.h2,{id:"before-you-start",children:"Before you start"}),e.jsx(o.p,{children:"Make sure you select the theme that you want to install along with your preferred mode from each collection."}),e.jsx(o.hr,{}),e.jsx(o.h2,{id:"step-1-install-packages",children:"Step 1: Install Packages"}),e.jsx(s,{fn:n=>`Install the ${r("CocoKits")} Angular components and the ${r(n.name)} theme`}),e.jsx(s,{fn:n=>e.jsx(g,{codeTabs:{npm:`npm i @cocokits/angular-components @cocokits/theme-${n.id}`,yarn:`yarn add @cocokits/angular-components @cocokits/theme-${n.id}`,pnpm:`pnpm add @cocokits/angular-components @cocokits/theme-${n.id}`}})}),e.jsx(o.hr,{}),e.jsx(o.h2,{id:"step-2-provide-theme-configuration",children:"Step 2: Provide Theme Configuration"}),e.jsx(s,{fn:n=>`Provide the ${r(n.name)} theme configuration in the root of your application.`}),e.jsx(o.h3,{id:"for-standalone-applications",children:"For Standalone Applications"}),e.jsx(o.p,{children:e.jsx(o.strong,{children:"main.ts"})}),e.jsx(s,{fn:f}),e.jsx(o.h3,{id:"for-module-based-applications",children:"For Module-Based Applications"}),e.jsx(o.p,{children:e.jsx(o.strong,{children:"app.module.ts"})}),e.jsx(s,{fn:y}),e.jsx(o.hr,{}),e.jsx(o.h2,{id:"step-3-add-component-styles",children:"Step 3: Add Component Styles"}),e.jsxs(o.p,{children:["Add the component styles to your ",e.jsx(o.code,{children:"angular.json"})," or ",e.jsx(o.code,{children:"project.json"})," file."]}),e.jsx(s,{fn:k}),e.jsx(o.hr,{}),e.jsx(o.h2,{id:"step-4-apply-theme-modes",children:"Step 4: Apply Theme Modes"}),e.jsxs(o.p,{children:[`To ensure that your application uses the correct styles, you need to include at least one mode for each collection in the theme.\r
