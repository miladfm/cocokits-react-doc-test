import{b as n,A as i}from"./avatar-DFOiHdi2.js";import{r as d,w as u}from"./preview.base-C0LkVZ1S.js";import{ag as t}from"./chunk-NUUEMKO5-BQaHiTAm.js";import"./mdx-page-with-theme-section-BvTOZ69R.js";import{r as s,t as c,s as v,c as f,D as p,j as g,E as m,a as h,u as l}from"./control.config-9nxOlqZS.js";import"./index-qVDZzPEr.js";import"./doc-page-tSLdifAh.js";import"./react-18-CVVedRj1.js";import"./index-DM35cTar.js";import"./iframe-DbFL9gZd.js";import"../sb-preview/runtime.js";import"./index-D2o5vtt7.js";import"./index-DrFu-skq.js";import"./addon.model-Bxedznpl.js";const y=`Combines an avatar with descriptive text in flexible layouts, ideal for user directories where names and titles need clear association with profile pictures. This component is particularly useful in contact lists, team management interfaces, and messaging systems where you need to show users with their roles or status information while optimizing space.\r
\r
**Key features:**\r
\r
- Configurable avatar positions (left/right/top/bottom)\r
- Adjustable text alignment options\r
- Separate click handler for the avatar element`,D={name:"Default",parameters:{docs:{description:{story:"Shows the default example with no additional configurations, providing an interactive example in its most basic form."}},cckAddon:{source:[{filename:"Source Code",language:"tsx",code:`
          ...
          `}],controls:[c()]}},render:e=>{var o;return t.jsx(t.Fragment,{children:(o=e.cckControl.themeComponentConfig.color)==null?void 0:o.values.map((r,a)=>t.jsx(n,{type:e.cckControl.type,color:r,title:"Alex Pearson",description:"UX Engineer",children:t.jsx(i,{src:"https://i.pravatar.cc?img=52"})},a))})}},F={component:n,title:"UI Components/AvatarLabel",tags:["status:new"],decorators:[u({insideBox:!0})],parameters:{docs:{description:{component:[y].join(`
`)}},cckAddon:{componentName:"avatarLabel"}},argTypes:{}},W=["Default","Type","Size","Color"];export{O as Color,D as Default,M as Size,X as Type,W as __namedExportsOrder,F as default};
