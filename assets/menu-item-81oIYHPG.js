import{j as o}from"./DocsRenderer-CFRXHY34-Ce_STi8V.js";import{u as r,f as z,O as x,E as R,j as b,k as O}from"./index-BO74zFUF.js";import{r as i}from"./index-C33_amOP.js";import"./react-18-B-IeCXFN.js";function S(e){const n=i.useRef(null),t=a=>{n.current=a};return[n.current,t]}function I(e){const{hostClassNames:n}=r({componentName:"divider",props:e,extraHostElementClassConditions:[{if:!!e.className,classes:()=>[e.className]}]});return o.jsx("div",{className:n,style:e.style})}I.__docgenInfo={description:"",methods:[],displayName:"Divider",props:{type:{required:!1,tsType:{name:"union",raw:"string | number | boolean | null",elements:[{name:"string"},{name:"number"},{name:"boolean"},{name:"null"}]},description:`The type of component.\r
\r
