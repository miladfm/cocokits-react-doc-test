...
export default App;
`)}),e.jsx(o.h3,{id:"step-3-import-component-styles-from-each-theme",children:"Step 3: Import Component Styles from Each Theme"}),e.jsxs(o.p,{children:["In your ",e.jsx(o.code,{children:"styles.scss"}),", include styles from both themes:"]}),e.jsx(o.p,{children:e.jsx(o.strong,{children:"styles.scss"})}),e.jsx(s,{fn:M}),e.jsx(o.hr,{}),e.jsx(o.h2,{id:"use-only-one-mode-from-each-collection",children:"Use Only One Mode from Each Collection"}),e.jsx(o.p,{children:`Each theme provides multiple modes for each collection (e.g., color, sizing). If your project requires only one mode per collection,\r
