import{z as E,A as C,H as B,J as f,o as T,F as m,d as v,B as x,T as j,v as k,x as _,K as N}from"./index-CJ4dMRjJ.js";import{r as d}from"./index-C33_amOP.js";import"./menu-item-B58pmHkI.js";import"./toggle-BNuwnKN4.js";import{j as e}from"./DocsRenderer-CFRXHY34-BQGoYUqN.js";import{c as P}from"./react-18-B-IeCXFN.js";import"./mdx-page-with-theme-section-RzKw2tZk.js";import{L as y,M as h,e as g}from"./control.config-Lq_-sO0J.js";import{w as O}from"./preview.base-CAQTzWSW.js";import"./preview--S8KCBjg.js";import"./iframe-D6lJ4O3E.js";import"./index-Cghhjyi9.js";import"./index-DrFu-skq.js";import"./addon.model-Bxedznpl.js";function D(t,o={}){const l=E.globalInstance(),a=C(),n=C(),r={...B,...o},p=r.decorator??(c=>c),i=R(r.zIndex);r.parentElement.appendChild(i);const s=P.createRoot(i);l.lock(),n.promise.then(()=>{s.unmount(),i.remove(),l.unlock()});const u=c=>{a.resolve(c)};return s.render(p(e.jsx(f,{config:r,afterClosedPromise:n,closedPromise:a,children:typeof t=="function"?d.createElement(t,{data:r.data,close:u}):t}))),{afterClosed:n.promise,closed:a.promise,close:u}}function R(t){const o=document.createElement("div");return o.style.position="fixed",o.style.top="0",o.style.left="0",o.style.width="100%",o.style.height="100%",o.style.zIndex=`${t}`,o.style.perspective="1000px",o.style.display="flex",o.style.position="fixed",o.style.justifyContent="center",o.style.alignItems="center",o.style.pointerEvents="none",o.style.touchAction="none",o}const F=`The \`Overlay\` CDK (Component Dev Kit) from \`@cocokits\` is a flexible utility that allows developers to create floating panels or elements that are positioned dynamically over the main content of an application. It is used to manage popups, modals, tooltips, dropdowns, and other temporary UI elements. The \`Overlay\` CDK provides robust control over placement, behavior, and interactions of overlay components, enhancing the user experience by offering non-intrusive, context-sensitive content.\r
\r
#### Features:\r
\r
...
- **Animations:** Offers support for custom animations, allowing overlays to appear and disappear with smooth transitions, contributing to a polished and engaging user experience.`,A=({data:t,close:o})=>{const[l,a]=d.useState(""),n=()=>{o({result:l})};return e.jsxs("div",{className:"overlay-dialog-standalone__host",children:[e.jsx("h3",{className:"overlay-dialog-standalone__header",children:"THIS IS A OVERLAY"}),e.jsxs("p",{className:"overlay-dialog-standalone__text",children:[e.jsx("b",{children:"Data: "}),t?JSON.stringify(t,null,2):""]}),e.jsx(m,{children:e.jsx(v,{placeholder:"Enter the result text",onInput:r=>a(r.currentTarget.value)})}),e.jsx(x,{onClick:n,children:"Close Overlay"})]})},b=({hasBackdrop:t,disableBackdropClose:o})=>{const l=T(),[a,n]=d.useState(""),[r,p]=d.useState(),i=async()=>{const u=await D(A,{disableBackdropClose:o,hasBackdrop:t,panelClass:["overlay-standalone-example"],decorator:c=>e.jsx(j.Provider,{value:l.themeConfig,children:c}),data:a?{text:a}:null}).afterClosed;p(u??{result:"No result"})};return e.jsxs("div",{className:"overlay-standalone__host",children:[e.jsx(m,{children:e.jsx(v,{placeholder:"Enter any text",onInput:s=>n(s.currentTarget.value)})}),e.jsxs("p",{className:"overlay-standalone__text",children:[e.jsx("b",{children:"Overlay Result: "}),JSON.stringify(r,null,2)]}),e.jsx(x,{onClick:i,children:"Open"})]})};b.__docgenInfo={description:"",methods:[],displayName:"OverlayStandaloneExample",props:{hasBackdrop:{required:!0,tsType:{name:"boolean"},description:""},disableBackdropClose:{required:!0,tsType:{name:"boolean"},description:""}}};const Q={name:"Standalone",decorators:[O({insideBox:!0})],parameters:{docs:{description:{story:"Shows the default example with no additional configurations, providing an interactive example in its most basic form."}},cckAddon:{renderConditions:[g("Overview")],source:[{filename:"OverlayDialogStandaloneExample.tsx",language:"tsx",code:`
            <%
          ...
          `}],hasControl:!0,controls:[y(),h()]}},render:t=>e.jsx(I,{hasBackdrop:t.cckControl.hasBackdrop,disableBackdropClose:t.cckControl.disableBackdropClose})},w=()=>{const{data:t,close:o}=N(),[l,a]=d.useState(""),n=()=>{o({result:l})};return e.jsxs("div",{className:"overlay-dialog-standalone__host",children:[e.jsx("h3",{className:"overlay-dialog-standalone__header",children:"THIS IS A OVERLAY"}),e.jsxs("p",{className:"overlay-dialog-standalone__text",children:[e.jsx("b",{children:"Data: "}),t?JSON.stringify(t,null,2):""]}),e.jsx(m,{children:e.jsx(v,{placeholder:"Enter the result text",onInput:r=>a(r.currentTarget.value)})}),e.jsx(x,{onClick:n,children:"Close Overlay"})]})},S=({hasBackdrop:t,disableBackdropClose:o})=>{const l="OverlayPortalAsComponentExample",[a,n]=d.useState(""),[r,p]=d.useState(),i=async()=>{const s=k.getWithId(l);if(s.getState().isOpened)return;const c=await s.open({disableBackdropClose:o,hasBackdrop:t,panelClass:["overlay-portal-as-component-example"],data:a?{text:a}:null}).afterClosed;p(c??{result:"No result"})};return e.jsxs("div",{className:"overlay-portal__host",children:[e.jsx(m,{children:e.jsx(v,{placeholder:"Enter any text",onInput:s=>n(s.currentTarget.value)})}),e.jsxs("p",{className:"overlay-portal__text",children:[e.jsx("b",{children:"Overlay Result: "}),JSON.stringify(r,null,2)]}),e.jsx(x,{onClick:i,children:"Open"}),e.jsx(_,{portalId:l,children:e.jsx(w,{})})]})};S.__docgenInfo={description:"",methods:[],displayName:"OverlayPortalAsComponentExample",props:{hasBackdrop:{required:!0,tsType:{name:"boolean"},description:""},disableBackdropClose:{required:!0,tsType:{name:"boolean"},description:""}}};const ee={name:"Portal as Component",decorators:[O({insideBox:!0})],parameters:{docs:{description:{story:"Shows the default example with no additional configurations, providing an interactive example in its most basic form."}},cckAddon:{renderConditions:[g("Overview")],source:[{filename:"OverlayPortalAsComponentExample.tsx",language:"tsx",code:`
          ...
          `}],hasControl:!0,controls:[y(),h()]}},render:t=>e.jsx(S,{hasBackdrop:t.cckControl.hasBackdrop,disableBackdropClose:t.cckControl.disableBackdropClose})},te={component:f,title:"CDK/Overlay",parameters:{docs:{description:{component:[F].join(`
`)}},cckAddon:{componentName:"overlay"}}},oe=["Standalone","Portal","PortalAsComponent"];export{X as Portal,ee as PortalAsComponent,Q as Standalone,oe as __namedExportsOrder,te as default};
