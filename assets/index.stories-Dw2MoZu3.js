import{B as n,p as a,U as e,I as d,t as l,s as r}from"./index-DNsOJRlX.js";import{j as o}from"./DocsRenderer-CFRXHY34-B0Fvrjtp.js";import"./mdx-page-with-theme-section-BwlOJl6T.js";import{C as k,t as m,c as A,s as E,O as h,P as b,a as I,d as T,e as s,x as u}from"./control.config-B1b8V5tA.js";import"./index-C33_amOP.js";import{r as v}from"./preview.base-fh5Wvfmp.js";import"./react-18-B-IeCXFN.js";import"./radio-group-DkpQeqkF.js";import"./menu-item-D_-ybvr7.js";import"./toggle-sGVxRRkH.js";import"./preview-D09guH6v.js";import"./iframe-CSwqnnwm.js";import"./index-Cghhjyi9.js";import"./index-DrFu-skq.js";import"./addon.model-Bxedznpl.js";const z=`
...
`,j={trash:z},w="A button in the context of UI is an interactive element that allows users to perform an action.\r\n\r\nThe `Button` from `@cocokits` provides a flexible, customizable button element within React applications. This component is compatible with multiple design system themes and allows for various configurations, including different button types, colors, and sizes.\r\n",Et={name:"Default",parameters:{docs:{description:{story:"Shows the default example with no additional configurations, providing an interactive example in its most basic form."}},cckAddon:{source:[{filename:"Source Code",language:"tsx",code:`
          ...
          `}],renderConditions:[s("Overview")],hasControl:!0,controls:[k("Button"),m(),A(),E(),h("none"),b("heartFill"),I(),T()]}},args:{},render:t=>o.jsxs(n,{...v(t),disabled:t.cckControl.disabled,children:[t.cckControl.leftIcon!=="none"&&o.jsx(a,{icon:t.cckIcons[t.cckControl.leftIcon]}),t.cckControl.text,t.cckControl.rightIcon!=="none"&&o.jsx(a,{icon:t.cckIcons[t.cckControl.rightIcon]})]})},ht={name:"Type",parameters:{docs:{description:{story:"Displays variations in appearance and functionality, demonstrating how different types can be used to create unique button styles."}},cckAddon:{renderConditions:[u("type"),s("Overview")],source:[{filename:"Source Code",language:"tsx",code:`
          ...
          `}]}},render:t=>{var c;return o.jsx(o.Fragment,{children:(c=t.cckControl.themeComponentConfig.type)==null?void 0:c.values.map((i,p)=>o.jsx(n,{type:i,children:i},p))})}},bt={name:"Size",parameters:{docs:{description:{story:"The size is adjustable to suit different design needs and screen dimensions, improving both aesthetics and usability."}},cckAddon:{renderConditions:[u("size"),s("Overview")],singleControls:["type"],source:[{filename:"Source Code",language:"tsx",code:`
          import { Button } from "@cocokits/react-components";
          ...
          `}],controls:[m()]}},render:t=>{var c;return o.jsx(o.Fragment,{children:(c=t.cckControl.themeComponentConfig.size)==null?void 0:c.values.map((i,p)=>o.jsxs(n,{type:t.cckControl.type,size:i,children:["Button - ",i]},p))})}},It={name:"Color",parameters:{docs:{description:{story:"Color options enable seamless integration with various themes or to highlight specific actions."}},cckAddon:{renderConditions:[u("color"),s("Overview")],singleControls:["type"],source:[{filename:"Source Code",language:"tsx",code:`
          import { Button } from "@cocokits/react-components";
...
`}];function g(t){return o.jsxs(ct,{children:[o.jsx(n,{type:t.cckExampleArgs.firstButtonType,size:t.cckExampleArgs.firstButtonSize,color:t.cckExampleArgs.firstButtonColor,children:"Skip"}),o.jsxs(n,{type:t.cckExampleArgs.secondButtonType,size:t.cckExampleArgs.secondButtonSize,color:t.cckExampleArgs.secondButtonColor,children:["Confirm",o.jsx(a,{icon:d.arrowRight})]})]})}const ct=r.div`
  ...
  width: 150px;
  gap: 12px;
`;g.__docgenInfo={description:"",methods:[],displayName:"StackVerticalButton",props:{cckExampleArgs:{required:!0,tsType:{name:"ExampleArgs"},description:""}}};const Mt={name:"Volume Button",parameters:{cckAddon:{renderConditions:[s("Examples")],source:rt,exampleStory:{templateArgsMap:nt,cssArgsMap:st}}},render:t=>o.jsx(it,{styles:t.cckExampleCssVariables,children:o.jsx(g,{cckExampleArgs:t.cckExampleArgs})})},it=r.div`
  ${({styles:t})=>l`
    ${t}
  `}
`,Vt={component:n,title:"UI Components/Button",decorators:[],parameters:{docs:{description:{component:[w].join(`
`)}},cckAddon:{componentName:"button"}},argTypes:{}},_t=["Default","Type","Size","Color","BackButtonStory","CopyLinkButtonStory","DeleteButtonStory","AddNewButtonStory","ShowMoreButtonStory","StackHorizontalButtonStory","StackVerticalButtonStory"];export{jt as AddNewButtonStory,Tt as BackButtonStory,It as Color,vt as CopyLinkButtonStory,Et as Default,zt as DeleteButtonStory,wt as ShowMoreButtonStory,bt as Size,$t as StackHorizontalButtonStory,Mt as StackVerticalButtonStory,ht as Type,_t as __namedExportsOrder,Vt as default};
