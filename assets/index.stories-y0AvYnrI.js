...
| React.ReactNode[]\r
| ((props: { isExpanded: boolean; disabled: boolean }) => React.ReactNode)`,elements:[{name:"ReactReactNode",raw:"React.ReactNode"},{name:"Array",elements:[{name:"ReactReactNode",raw:"React.ReactNode"}],raw:"React.ReactNode[]"},{name:"unknown"}]},description:""},children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""}}};const J=f.createContext(null),d=({type:n,size:e,color:o,additional:i,value:r,disabled:s,children:a})=>{const c=re(),p=r??c,g=Z(),y=f.useRef(null),u=xe(y,{initializeValues:{dimension:{height:0}}});if(!g)throw new Error("AccordionPanel must be used within an Accordion.");ye(()=>g.addPanel({id:c,value:p}));const b=g.isExpanded(c),{classNames:x,hostClassNames:w}=V({componentName:"accordionPanel",props:{type:n,size:e,color:o,additional:i},extraHostElementClassConditions:[{if:b,classes:h=>[h.expanded]},{if:!b,classes:h=>[h.collapsed]},{if:s,classes:h=>[h.disabled]}]});L(()=>{if(!y.current)return;const h=b?He(y.current):0;u==null||u.setDimension({height:h});const P=g.getState().instantAnimation?u==null?void 0:u.apply():u==null?void 0:u.animate({easing:Se,duration:g.getState().animationDuration});b&&(P==null||P.then(()=>{y.current&&(y.current.style.height="auto")}))},[b]);const[_,q]=be(a,"AccordionHeader");return t.jsx(J.Provider,{value:{id:c,disabled:s},children:t.jsxs("div",{className:w,children:[_,t.jsx("div",{ref:y,className:x.contentWrapper,children:q})]})})};d.displayName="AccordionPanel";function He(n){n.style.opacity="0",n.style.display="block",n.style.height="auto";const e=n.offsetHeight;return n.style.height="0",n.style.opacity="1",e}const Se=n=>1-(1-n)*(1-n);d.__docgenInfo={description:"",methods:[],displayName:"AccordionPanel",props:{type:{required:!1,tsType:{name:"union",raw:"string | number | boolean | null",elements:[{name:"string"},{name:"number"},{name:"boolean"},{name:"null"}]},description:`The type of component.\r
\r
When set to \`null\`, no specific type is applied (Not event the default value).\r
This allows for more flexible styling options if the desired size is not available in the selected theme.`},color:{required:!1,tsType:{name:"union",raw:"string | number | boolean | null",elements:[{name:"string"},{name:"number"},{name:"boolean"},{name:"null"}]},description:`The color of component.\r
\r
...
| React.ReactNode[]\r
| ((props: { isExpanded: boolean; disabled: boolean }) => React.ReactNode)`,elements:[{name:"ReactReactNode",raw:"React.ReactNode"},{name:"Array",elements:[{name:"ReactReactNode",raw:"React.ReactNode"}],raw:"React.ReactNode[]"},{name:"unknown"}]},description:""},children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""}}};const Te=`The core wrapper that manages the state and structure of all panels. It handles global behavior such as single/multiple expansion, nesting, accessibility, and keyboard control.\r
\r
**Features:**\r
...
\r
- **Nested Support:**\r
Support placing accordions inside accordion content, enabling complex hierarchical layouts.\r
\r
- **Custom Logic Guard:**\r
Before collapsing a panel, allow showing a confirmation dialog or running async logic to approve the action.`,De={name:"Default",parameters:{docs:{description:{story:"Shows the default example with no additional configurations, providing an interactive example in its most basic form."}},cckAddon:{source:[{filename:"Source Code",language:"tsx",code:`
          ...
          `}],singleControls:["mode"],hasControl:!1,controls:[E("Mode",["Single","Multi"])]}},render:n=>t.jsx(Pe,{multiMode:n.cckControl.mode==="Multi"})},Ze={component:v,title:"UI Components/Accordion",tags:["status:new"],subcomponents:{AccordionPanel:d,AccordionHeader:l},decorators:[ce({insideBox:!0},{width:"400px"})],parameters:{docs:{description:{component:[Te].join(`
`)}},cckAddon:{componentName:"accordion",subcomponents:{AccordionPanel:{name:"accordionPanel",description:"A collapsible section inside an accordion. Each panel works independently but syncs with the parent for state tracking and expansion logic."},AccordionHeader:{name:"accordionHeader",description:"Acts as the toggle button for the panel. It can be styled or fully replaced using custom children, enabling full flexibility in the header’s layout and content."}}}},argTypes:{}},Je=["Default","Type","Size","Color","Disabled","CustomIcon","Nested","Control"];export{Be as Color,Ge as Control,Xe as CustomIcon,De as Default,Ue as Disabled,Ye as Nested,$e as Size,We as Type,Je as __namedExportsOrder,Ze as default};
