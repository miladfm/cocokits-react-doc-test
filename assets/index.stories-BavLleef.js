...
`}];function He(e){const{control:n,formState:{errors:o,isValid:r}}=Me({mode:"onTouched"});return t.jsxs(C,{children:[t.jsx(F,{children:"Username"}),t.jsx(T,{name:"username",control:n,rules:{required:"Username is required",minLength:{value:3,message:"Must be at least 3 characters"},maxLength:{value:10,message:"Cannot exceed 10 characters"},pattern:{value:/^[A-Za-z0-9-]+$/,message:"Only letters, digits, and hyphens allowed"}}}),r&&t.jsxs(M,{color:e.cckExampleArgs.hintColor,children:[t.jsx(x,{icon:w.checkCircle}),t.jsx("span",{children:"Username is available!"})]}),o.username&&t.jsxs(N,{children:[t.jsx(x,{icon:w.warning}),t.jsx("span",{children:o.username.message})]})]})}He.__docgenInfo={description:"",methods:[],displayName:"InputHintSuccess",props:{cckExampleArgs:{required:!0,tsType:{name:"ExampleArgs"},description:""}}};const zo={name:"Input Hint Success",parameters:{cckAddon:{renderConditions:[I("Examples")],source:Vt,exampleStory:{templateArgsMap:$t,cssArgsMap:_t}}},render:e=>t.jsx(zt,{styles:e.cckExampleCssVariables,children:t.jsx(He,{cckExampleArgs:e.cckExampleArgs})})},zt=h.div`
  ${({styles:e})=>L`
    ${e}
  `}
...
`}];function qe(e){const{control:n,formState:{errors:o}}=Me({mode:"onTouched"});return t.jsxs(C,{children:[t.jsx(F,{children:"Email"}),t.jsx(T,{type:"email",name:"email",control:n,rules:{required:"Email is required",pattern:{value:/^[^\s@]+@[^\s@]+\.[^\s@]+$/,message:"Enter a valid email address"}}}),o.email&&t.jsxs(N,{children:[t.jsx(x,{icon:w.warning}),t.jsx("span",{children:o.email.message})]})]})}qe.__docgenInfo={description:"",methods:[],displayName:"EmailValidation",props:{cckExampleArgs:{required:!0,tsType:{name:"ExampleArgs"},description:""}}};const Ho={name:"Email Validation",parameters:{cckAddon:{renderConditions:[I("Examples")],source:Bt,exampleStory:{templateArgsMap:Ht,cssArgsMap:qt}}},render:e=>t.jsx(Ut,{styles:e.cckExampleCssVariables,children:t.jsx(qe,{cckExampleArgs:e.cckExampleArgs})})},Ut=h.div`
  ${({styles:e})=>L`
    ${e}
  `}
`,Nt={[i.FramesX]:{iconSize:"xl"},[i.CocoKits]:{iconSize:"lg"}},Kt={[i.FramesX]:{},[i.CocoKits]:{}},Wt=[{language:"tsx",filename:"PrefixSuffixSearch.tsx",code:`
import { Icons } from '@cocokits/common-icons';
...
`}];function Ue(e){return t.jsxs(C,{children:[t.jsx(F,{children:"Website URL"}),t.jsx(U,{children:"https://"}),t.jsx(T,{})]})}Ue.__docgenInfo={description:"",methods:[],displayName:"LeadingWebsite",props:{cckExampleArgs:{required:!0,tsType:{name:"ExampleArgs"},description:""}}};const Bo={name:"Leading Website",parameters:{cckAddon:{renderConditions:[I("Examples")],source:Yt,exampleStory:{templateArgsMap:Dt,cssArgsMap:Gt}}},render:e=>t.jsx(Zt,{styles:e.cckExampleCssVariables,children:t.jsx(Ue,{cckExampleArgs:e.cckExampleArgs})})},Zt=h.div`
  ${({styles:e})=>L`
    ${e}
  `}
...
`}];function Ne(e){return t.jsxs(C,{children:[t.jsx(F,{children:"Choose domain name"}),t.jsx(T,{}),t.jsx(H,{children:".com"})]})}Ne.__docgenInfo={description:"",methods:[],displayName:"TrailingDomain",props:{cckExampleArgs:{required:!0,tsType:{name:"ExampleArgs"},description:""}}};const Uo={name:"Trailing Domain",parameters:{cckAddon:{renderConditions:[I("Examples")],source:en,exampleStory:{templateArgsMap:Jt,cssArgsMap:Qt}}},render:e=>t.jsx(tn,{styles:e.cckExampleCssVariables,children:t.jsx(Ne,{cckExampleArgs:e.cckExampleArgs})})},tn=h.div`
  ${({styles:e})=>L`
    ${e}
  `}
...
`}];function Ke(e){return t.jsxs(C,{children:[t.jsx(F,{children:"Enter username"}),t.jsx(U,{children:t.jsx(x,{icon:w.user})}),t.jsx(T,{})]})}Ke.__docgenInfo={description:"",methods:[],displayName:"LeadingIcon",props:{cckExampleArgs:{required:!0,tsType:{name:"ExampleArgs"},description:""}}};const No={name:"Leading Icon",parameters:{cckAddon:{renderConditions:[I("Examples")],source:rn,exampleStory:{templateArgsMap:nn,cssArgsMap:on}}},render:e=>t.jsx(an,{styles:e.cckExampleCssVariables,children:t.jsx(Ke,{cckExampleArgs:e.cckExampleArgs})})},an=h.div`
  ${({styles:e})=>L`
    ${e}
  `}
...
`},{language:"scss",filename:"global.scss",code:`
      ...
      }`,visibleConditions:[e=>e.id===i.FramesX]}],Nn=h(Y)`
  min-width: 190px;
`,Kn=h(xt)`
  display: flex;
  gap: 8px;
...
`}];function at(e){const[n,o]=_.useState(0),r=150;return t.jsxs(C,{children:[t.jsx(F,{children:"Description"}),t.jsx(Oe,{maxLength:r,placeholder:"Short project description",onChange:a=>o(a.target.value.length)}),t.jsxs(M,{children:[n,"/",r," characters max"]})]})}at.__docgenInfo={description:"",methods:[],displayName:"TextareaMaxChar",props:{cckExampleArgs:{required:!0,tsType:{name:"ExampleArgs"},description:""}}};const Jo={name:"Textarea Max Char",parameters:{cckAddon:{renderConditions:[I("Examples")],source:ro,exampleStory:{templateArgsMap:no,cssArgsMap:oo}}},render:e=>t.jsx(io,{styles:e.cckExampleCssVariables,children:t.jsx(at,{cckExampleArgs:e.cckExampleArgs})})},io=h.div`
  ${({styles:e})=>L`
    ${e}
  `}
