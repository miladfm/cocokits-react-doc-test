import{j as e,M as t}from"./DocsRenderer-CFRXHY34-BwR9UgVr.js";import{useMDXComponents as o}from"./index-Ch4n-_Zu.js";import"./index-2c5hLoMp.js";import{M as r}from"./mdx-page-with-theme-section-e5iHczJi.js";import"./index-C33_amOP.js";import"./react-18-B-IeCXFN.js";import"./iframe-B2AMzJkg.js";import"./index-Cghhjyi9.js";import"./index-DrFu-skq.js";import"./preview-Bzb66UsU.js";const c=[{id:"overview",name:"Overview"},{id:"storybook-structure-and-guidelines",name:"Storybook Structure"},{id:"cocokits-specific-configuration",name:"CocoKits Configuration"}];function s(i){const n={code:"code",h2:"h2",h3:"h3",hr:"hr",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...o(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(t,{title:"Contributing/Kits Doc Structure"}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"subcomponents:"})," Optional. Use this if the component has subcomponents that do not require their own documentation page (e.g., a prefix component used within a form field).",`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"name"}),": The name of subComponent, if set to ",e.jsx(n.code,{children:"null"})," then no documentation will be generate in API doc page."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"argsType"}),": Optional. Use this to override subcomponent APIs if Storybook cannot generate them correctly."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"description:"})," Optional. THe description of the component that should be shown under API tab"]}),`
`]}),`
`]}),`
...
`]}),`
`]}),`
`]}),e.jsx(n.h2,{id:"conclusion",children:"Conclusion"}),e.jsx(n.p,{children:"By following these guidelines, you can create consistent, well-organized, and user-friendly documentation for CocoKits. Refer to existing examples and the official Storybook documentation for further details."})]})]})}function g(i={}){const{wrapper:n}={...o(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(s,{...i})}):s(i)}export{g as default,c as tocItems};
