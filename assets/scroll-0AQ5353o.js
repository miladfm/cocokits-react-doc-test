import{ag as e,ah as c}from"./chunk-NUUEMKO5-LLHHQr8R.js";import{useMDXComponents as n}from"./index-DOvxcyG1.js";import{M as o}from"./mdx-page-with-theme-section-DmqQ5M3U.js";import"./index-qVDZzPEr.js";import"./doc-page-DZtkdTH4.js";import"./react-18-CVVedRj1.js";import"./index-DM35cTar.js";import"./iframe-C3BREnma.js";import"../sb-preview/runtime.js";import"./index-D2o5vtt7.js";import"./index-DrFu-skq.js";const i=[{id:"selection_scrolllocker",name:"ScrollLocker"}];function r(s){const l={code:"code",h2:"h2",h3:"h3",h4:"h4",h5:"h5",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...n(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(c,{title:"Utils/Scroll"}),`
...
`})}),e.jsx(l.p,{children:"Adds a callback function that is invoked whenever the scroll lock state changes."}),e.jsx(l.h5,{id:"parameters",children:"Parameters"}),e.jsxs("table",{class:"arg-type-table arg-type-table--full-width",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Parameter"}),e.jsx("th",{children:"Type"}),e.jsx("th",{children:"Description"})]})}),e.jsx("tbody",{children:e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(l.p,{children:e.jsx(l.code,{children:"callback"})})}),e.jsx("td",{children:e.jsx(l.p,{children:e.jsx(l.code,{children:"(isLock: boolean) => void"})})}),e.jsx("td",{children:e.jsxs(l.p,{children:["A function that receives the current lock state (",e.jsx(l.code,{children:"true"})," for locked, ",e.jsx(l.code,{children:"false"})," for unlocked)."]})})]})})]}),e.jsx(l.h5,{id:"returns-1",children:"Returns"}),e.jsx(l.p,{children:e.jsx(l.code,{children:"void"})}),e.jsx(l.h5,{id:"example-2",children:"Example"}),e.jsx(l.pre,{children:e.jsx(l.code,{className:"language-typescript",children:`const locker = ScrollLocker.globalInstance();\r
...
the body width, particularly when the content resizes.`]}),e.jsx(l.h5,{id:"parameters-1",children:"Parameters"}),e.jsxs("table",{class:"arg-type-table arg-type-table--full-width",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Parameter"}),e.jsx("th",{children:"Type"}),e.jsx("th",{children:"Default value"}),e.jsx("th",{children:"Description"})]})}),e.jsx("tbody",{children:e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(l.p,{children:e.jsx(l.code,{children:"hideScrollbar"})})}),e.jsx("td",{children:e.jsx(l.p,{children:e.jsx(l.code,{children:"boolean"})})}),e.jsx("td",{children:e.jsx(l.p,{children:e.jsx(l.code,{children:"false"})})}),e.jsxs("td",{children:[e.jsx(l.p,{children:"Whether to hide the scrollbar when locking."}),e.jsxs(l.ul,{children:[`
...
`})}),e.jsx(l.p,{children:"Removes a previously added scroll lock change listener."}),e.jsx(l.h5,{id:"parameters-2",children:"Parameters"}),e.jsxs("table",{class:"arg-type-table arg-type-table--full-width",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Parameter"}),e.jsx("th",{children:"Type"}),e.jsx("th",{children:"Description"})]})}),e.jsx("tbody",{children:e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(l.p,{children:e.jsx(l.code,{children:"callback"})})}),e.jsx("td",{children:e.jsx(l.p,{children:e.jsx(l.code,{children:"(isLock: boolean) => void"})})}),e.jsx("td",{children:e.jsx(l.p,{children:"The listener function to be removed."})})]})})]}),e.jsx(l.h5,{id:"returns-3",children:"Returns"}),e.jsx(l.p,{children:e.jsx(l.code,{children:"void"})}),e.jsx(l.h5,{id:"example-4",children:"Example"}),e.jsx(l.pre,{children:e.jsx(l.code,{className:"language-typescript",children:`const locker = ScrollLocker.globalInstance();\r
