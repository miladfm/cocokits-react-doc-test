import{B as n,j as a,P as e,I as d,y as r,Q as l}from"./doc-page-tSLdifAh.js";import{ag as o}from"./chunk-NUUEMKO5-BQaHiTAm.js";import"./mdx-page-with-theme-section-BvTOZ69R.js";import{r as s,z as k,t as m,c as A,s as h,M as E,N as b,a as I,d as T,u}from"./control.config-9nxOlqZS.js";import"./index-qVDZzPEr.js";import{r as v}from"./preview.base-C0LkVZ1S.js";import"./react-18-CVVedRj1.js";import"./index-DM35cTar.js";import"./menu-item-D5FwA0AX.js";import"./toggle-DJDw_Z6a.js";import"./iframe-DbFL9gZd.js";import"../sb-preview/runtime.js";import"./index-D2o5vtt7.js";import"./index-DrFu-skq.js";import"./addon.model-Bxedznpl.js";const z=`
...
`,w={info:z,trash:j},M="A button in the context of UI is an interactive element that allows users to perform an action.\r\n\r\nThe `Button` from `@cocokits` provides a flexible, customizable button element within React applications. This component is compatible with multiple design system themes and allows for various configurations, including different button types, colors, and sizes.\r\n",Et={name:"Default",parameters:{docs:{description:{story:"Shows the default example with no additional configurations, providing an interactive example in its most basic form."}},cckAddon:{source:[{filename:"Source Code",language:"tsx",code:`
          ...
          `}],controls:[m()]}},render:t=>{var c;return o.jsx(o.Fragment,{children:(c=t.cckControl.themeComponentConfig.color)==null?void 0:c.values.map((i,p)=>o.jsx(n,{type:t.cckControl.type,color:i,children:i},p))})}},H={[e.FramesX]:{},[e.CocoKits]:{}},V={[e.FramesX]:{},[e.CocoKits]:{}},$=[{language:"tsx",filename:"BackButton.tsx",code:`
...
`}];function y(t){return o.jsxs(n,{children:[o.jsx(a,{icon:d.arrowLeft}),o.jsx("span",{children:"Back"})]})}y.__docgenInfo={description:"",methods:[],displayName:"BackButton",props:{cckExampleArgs:{required:!0,tsType:{name:"ExampleArgs"},description:""}}};const vt={name:"Back Button",parameters:{cckAddon:{renderConditions:[s("Examples")],source:$,exampleStory:{templateArgsMap:H,cssArgsMap:V}}},render:t=>o.jsx(_,{styles:t.cckExampleCssVariables,children:o.jsx(y,{cckExampleArgs:t.cckExampleArgs})})},_=r.div`
  ${({styles:t})=>l`
    ${t}
  `}
`,R={[e.FramesX]:{buttonType:"ghost"},[e.CocoKits]:{buttonType:"outline"}},L={[e.FramesX]:{},[e.CocoKits]:{}},N=[{language:"tsx",filename:"CopyLinkButton.tsx",code:`
import { Icons } from '@cocokits/common-icons';
...
`}];function x(t){return o.jsxs(n,{type:t.cckExampleArgs.buttonType,children:[o.jsx(a,{icon:d.link}),o.jsx("span",{children:"Copy Link"})]})}x.__docgenInfo={description:"",methods:[],displayName:"CopyLinkButton",props:{cckExampleArgs:{required:!0,tsType:{name:"ExampleArgs"},description:""}}};const zt={name:"Copy Link Button",parameters:{cckAddon:{renderConditions:[s("Examples")],source:N,exampleStory:{templateArgsMap:R,cssArgsMap:L}}},render:t=>o.jsx(O,{styles:t.cckExampleCssVariables,children:o.jsx(x,{cckExampleArgs:t.cckExampleArgs})})},O=r.div`
  ${({styles:t})=>l`
    ${t}
  `}
`,F={[e.FramesX]:{buttonType:"default",buttonColor:"danger"},[e.CocoKits]:{buttonType:"primary",buttonColor:"error"}},D={[e.FramesX]:{},[e.CocoKits]:{}},K=[{language:"tsx",filename:"DeleteButton.tsx",code:`
