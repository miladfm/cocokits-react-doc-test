import{F as C,L as F,_ as U,$ as V,j as x,d as T,a0 as z,a1 as H,a2 as O,a3 as N,e as Me,S as Y,O as P,C as gt,N as i,I as w,n as L,m as h,a4 as Oe,i as xt}from"./index-JWD7Mr_9.js";import{j as t}from"./DocsRenderer-CFRXHY34-BjW3q4eN.js";import"./mdx-page-with-theme-section-DF3pGNGH.js";import{l as ee,p as te,Q as ne,R as oe,S as re,T as ie,t as ae,c as se,s as le,a as ce,U as de,V as ue,r as pe,d as me,b as fe,W as ge,e as I,m as ht,f as St,g as vt,v as kt,B as Ct}from"./control.config-BeKCBS3w.js";import{r as _,g as yt}from"./index-C33_amOP.js";import{r as xe}from"./preview.base-BPa6Ngeu.js";import"./menu-item-BF5s_Wzz.js";import"./toggle-D2NTfzx5.js";import"./react-18-B-IeCXFN.js";import"./preview-BLxfJc_2.js";import"./iframe-lR3HNRPu.js";import"./index-Cghhjyi9.js";import"./index-DrFu-skq.js";import"./addon.model-Bxedznpl.js";function Re(e){const n=parseFloat(e.replace(/,/g,""));return isNaN(n)?"":n.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function $e(e){return e.replace(/,/g,"")}const bt="The `FormField` from `@cocokits` serves as a versatile wrapper designed to structure and associate form inputs, labels, and validation messages seamlessly. By ensuring consistent spacing, and alignment, the FormField enhances the overall user experience, making forms more intuitive and user-friendly. This component integrates effortlessly with multiple design system themes, maintaining a cohesive look and feel across various application interfaces.\r\n\r\n`FormField` is a component used to wrap several `CocoKits` components and apply common text field styles, error, and hint messages. In this document, `FormField` refers to the wrapper component, while form controller refers to the component that the `FormField` is wrapping (e.g., the input, textarea, select, etc.).\r\n\r\nThe following `CocoKits` components are designed to work inside a `FormField`:\r\n\r\n- `<Input>`\r\n- `<Textarea>`\r\n- `<Select>`\r\n- `<ChipList>`",To={name:"Input",parameters:{docs:{description:{story:"Shows the default example with no additional configurations, providing an interactive example in its most basic form."}},cckAddon:{renderConditions:[I("Overview")],source:[{filename:"Source Code",language:"tsx",code:`
...
`}];function He(e){const{control:n,formState:{errors:o,isValid:r}}=Oe({mode:"onTouched"});return t.jsxs(C,{children:[t.jsx(F,{children:"Username"}),t.jsx(T,{name:"username",control:n,rules:{required:"Username is required",minLength:{value:3,message:"Must be at least 3 characters"},maxLength:{value:10,message:"Cannot exceed 10 characters"},pattern:{value:/^[A-Za-z0-9-]+$/,message:"Only letters, digits, and hyphens allowed"}}}),r&&t.jsxs(O,{color:e.cckExampleArgs.hintColor,children:[t.jsx(x,{icon:w.checkCircle}),t.jsx("span",{children:"Username is available!"})]}),o.username&&t.jsxs(N,{children:[t.jsx(x,{icon:w.warning}),t.jsx("span",{children:o.username.message})]})]})}He.__docgenInfo={description:"",methods:[],displayName:"InputHintSuccess",props:{cckExampleArgs:{required:!0,tsType:{name:"ExampleArgs"},description:""}}};const Vo={name:"Input Hint Success",parameters:{cckAddon:{renderConditions:[I("Examples")],source:Vt,exampleStory:{templateArgsMap:$t,cssArgsMap:_t}}},render:e=>t.jsx(zt,{styles:e.cckExampleCssVariables,children:t.jsx(He,{cckExampleArgs:e.cckExampleArgs})})},zt=h.div`
  ${({styles:e})=>L`
    ${e}
  `}
...
`}];function lt(e){const[n,o]=_.useState("");return t.jsxs(C,{children:[t.jsx(F,{children:"Select currency"}),t.jsx(U,{children:t.jsx(x,{icon:w.dollarMoney})}),t.jsx(T,{value:n,onFocus:()=>o($e(n)),onBlur:()=>o(Re(n)),onChange:r=>o(r.target.value)})]})}lt.__docgenInfo={description:"",methods:[],displayName:"LeadingCurrency",props:{cckExampleArgs:{required:!0,tsType:{name:"ExampleArgs"},description:""}}};const Qo={name:"Leading Currency",parameters:{cckAddon:{renderConditions:[I("Examples")],source:go,exampleStory:{templateArgsMap:mo,cssArgsMap:fo}}},render:e=>t.jsx(xo,{styles:e.cckExampleCssVariables,children:t.jsx(lt,{cckExampleArgs:e.cckExampleArgs})})},xo=h.div`
  ${({styles:e})=>L`
    ${e}
  `}
`,er={component:C,subcomponents:{Label:F,Leading:U,Trailing:H,Prefix:V,Suffix:z,Hint:O,Error:N},title:"UI Components/FormField",decorators:[],parameters:{docs:{description:{component:[bt].join(`
`)}},cckAddon:{componentName:"formField",subcomponents:{Label:{name:"label"},Leading:{name:"leading"},Trailing:{name:"trailing"},Prefix:{name:"prefix"},Suffix:{name:"suffix"},Hint:{name:"hint"},Error:{name:"error"}}}}},tr=["Input","Textarea","Select","ChipList","PasswordStory","InputLinkStory","InputSuffixSuccessStory","InputHintSuccessStory","EmailValidationStory","PrefixSuffixSearchStory","LeadingWebsiteStory","TrailingDomainStory","LeadingIconStory","TrailingCopyStory","TrailingSelectAmountStory","TrailingCustomColorStory","PrefixIconSelectStory","SuffixCardPatternStory","SelectPreviewTagStory","PhoneNumberStory","TextareaMaxCharStory","InputSideLabelStory","LeadingCurrencyStory"];export{Oo as ChipList,zo as EmailValidationStory,To as Input,Vo as InputHintSuccessStory,$o as InputLinkStory,Jo as InputSideLabelStory,_o as InputSuffixSuccessStory,Qo as LeadingCurrencyStory,Uo as LeadingIconStory,qo as LeadingWebsiteStory,Ro as PasswordStory,Yo as PhoneNumberStory,Xo as PrefixIconSelectStory,Ho as PrefixSuffixSearchStory,Mo as Select,Go as SelectPreviewTagStory,Do as SuffixCardPatternStory,wo as Textarea,Zo as TextareaMaxCharStory,No as TrailingCopyStory,Wo as TrailingCustomColorStory,Bo as TrailingDomainStory,Ko as TrailingSelectAmountStory,tr as __namedExportsOrder,er as default};
