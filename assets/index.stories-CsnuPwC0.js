...
`}];function He(e){const{control:n,formState:{errors:o,isValid:r}}=Oe({mode:"onTouched"});return t.jsxs(C,{children:[t.jsx(F,{children:"Username"}),t.jsx(T,{name:"username",control:n,rules:{required:"Username is required",minLength:{value:3,message:"Must be at least 3 characters"},maxLength:{value:10,message:"Cannot exceed 10 characters"},pattern:{value:/^[A-Za-z0-9-]+$/,message:"Only letters, digits, and hyphens allowed"}}}),r&&t.jsxs(O,{color:e.cckExampleArgs.hintColor,children:[t.jsx(x,{icon:w.checkCircle}),t.jsx("span",{children:"Username is available!"})]}),o.username&&t.jsxs(K,{children:[t.jsx(x,{icon:w.warning}),t.jsx("span",{children:o.username.message})]})]})}He.__docgenInfo={description:"",methods:[],displayName:"InputHintSuccess",props:{cckExampleArgs:{required:!0,tsType:{name:"ExampleArgs"},description:""}}};const Vo={name:"Input Hint Success",parameters:{cckAddon:{renderConditions:[I("Examples")],source:Vt,exampleStory:{templateArgsMap:$t,cssArgsMap:_t}}},render:e=>t.jsx(zt,{styles:e.cckExampleCssVariables,children:t.jsx(He,{cckExampleArgs:e.cckExampleArgs})})},zt=h.div`
  ${({styles:e})=>L`
    ${e}
  `}
...
`}];function Ke(e){return t.jsxs(C,{children:[t.jsx(F,{children:"Choose domain name"}),t.jsx(T,{}),t.jsx(H,{children:".com"})]})}Ke.__docgenInfo={description:"",methods:[],displayName:"TrailingDomain",props:{cckExampleArgs:{required:!0,tsType:{name:"ExampleArgs"},description:""}}};const Bo={name:"Trailing Domain",parameters:{cckAddon:{renderConditions:[I("Examples")],source:en,exampleStory:{templateArgsMap:Jt,cssArgsMap:Qt}}},render:e=>t.jsx(tn,{styles:e.cckExampleCssVariables,children:t.jsx(Ke,{cckExampleArgs:e.cckExampleArgs})})},tn=h.div`
  ${({styles:e})=>L`
    ${e}
  `}
...
`}];function Ne(e){return t.jsxs(C,{children:[t.jsx(F,{children:"Enter username"}),t.jsx(U,{children:t.jsx(x,{icon:w.user})}),t.jsx(T,{})]})}Ne.__docgenInfo={description:"",methods:[],displayName:"LeadingIcon",props:{cckExampleArgs:{required:!0,tsType:{name:"ExampleArgs"},description:""}}};const Uo={name:"Leading Icon",parameters:{cckAddon:{renderConditions:[I("Examples")],source:rn,exampleStory:{templateArgsMap:nn,cssArgsMap:on}}},render:e=>t.jsx(an,{styles:e.cckExampleCssVariables,children:t.jsx(Ne,{cckExampleArgs:e.cckExampleArgs})})},an=h.div`
  ${({styles:e})=>L`
    ${e}
  `}
...
`},{language:"scss",filename:"global.scss",code:`
      ...
      }`,visibleConditions:[e=>e.id===i.FramesX]}],Kn=h(Y)`
  min-width: 190px;
`,Nn=h(xt)`
  display: flex;
  gap: 8px;
