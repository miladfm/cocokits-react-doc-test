import{R as r,P as c,y as t,Q as i,j as k,I as b}from"./doc-page-tSLdifAh.js";import{ag as o}from"./chunk-NUUEMKO5-BQaHiTAm.js";import"./mdx-page-with-theme-section-BvTOZ69R.js";import{r as s,z as A,t as p,c as E,s as z,a as L,L as I,B as j,d as B,u}from"./control.config-9nxOlqZS.js";import{r as $}from"./index-qVDZzPEr.js";import{r as G}from"./preview.base-C0LkVZ1S.js";import"./react-18-CVVedRj1.js";import"./index-DM35cTar.js";import"./menu-item-D5FwA0AX.js";import"./toggle-DJDw_Z6a.js";import"./iframe-DbFL9gZd.js";import"../sb-preview/runtime.js";import"./index-D2o5vtt7.js";import"./index-DrFu-skq.js";import"./addon.model-Bxedznpl.js";const T="The `Checkbox` from `@cocokits` is an essential UI element designed to enable users to make binary selections within React applications. Whether used in forms, settings panels, or anywhere multiple selections are required, this component provides a reliable and customizable solution that aligns seamlessly with various design system themes.\r\n\r\n#### Features:\r\n- **Theming Flexibility:** Fully compatible with multiple design system themes, ensuring that the checkbox adapts its appearance to match the overall aesthetic of the application without additional configuration.",je={name:"Default",parameters:{docs:{description:{story:"Shows the default example with no additional configurations, providing an interactive example in its most basic form."}},cckAddon:{renderConditions:[s("Overview")],source:[{filename:"Source Code",language:"tsx",code:`
          ...
          `}],hasControl:!0,controls:[A("Checkbox Label"),p(),E(),z(),L(),I(),j(),B()]}},render:e=>o.jsx(r,{...G(e),indeterminate:e.cckControl.indeterminate,checked:e.cckControl.checked,disabled:e.cckControl.disabled,children:e.cckControl.text})},Be={name:"Size",parameters:{docs:{description:{story:"The size is adjustable to suit different design needs and screen dimensions, improving both aesthetics and usability."}},cckAddon:{renderConditions:[u("size"),s("Overview")],singleControls:["type"],source:[{filename:"Source Code",language:"tsx",code:`
            import { Checkbox } from "@cocokits/react-components";
            ...
            `}],controls:[p()]}},render:e=>{var n;return o.jsx(o.Fragment,{children:(n=e.cckControl.themeComponentConfig.size)==null?void 0:n.values.map((a,l)=>o.jsxs(r,{type:e.cckControl.type,size:a,children:["Checkbox - ",a]},l))})}},$e={name:"Color",parameters:{docs:{description:{story:"Color options enable seamless integration with various themes or to highlight specific actions."}},cckAddon:{renderConditions:[u("color"),s("Overview")],singleControls:["type"],source:[{filename:"Source Code",language:"tsx",code:`
            import { Checkbox } from "@cocokits/react-components";
...
`},{language:"scss",filename:"global.scss",code:`
      ...
      }`,visibleConditions:[e=>e.id===c.FramesX]}],N=t.span`
  color: var(--checkbox-group-column-color);
  font-style: italic;
  font-family: var(--checkbox-group-column-font-family);
`,W=t.div`
  ...
  flex-direction: column;
  gap: 12px;
`,h={Label:N,CheckboxGroupColumn:W};function y(e){return o.jsxs(h.CheckboxGroupColumn,{children:[o.jsx(h.Label,{children:"My hobbies"}),o.jsx(r,{size:e.cckExampleArgs.size,value:1,children:"Comic books"}),o.jsx(r,{size:e.cckExampleArgs.size,value:2,children:"Listen to music"}),o.jsx(r,{size:e.cckExampleArgs.size,value:3,children:"Travel the world"}),o.jsx(r,{size:e.cckExampleArgs.size,value:4,children:"Watch movies"})]})}y.__docgenInfo={description:"",methods:[],displayName:"CheckboxGroupColumn",props:{cckExampleArgs:{required:!0,tsType:{name:"ExampleArgs"},description:""}}};const we={name:"Checkbox Group Column",parameters:{cckAddon:{renderConditions:[s("Examples")],source:q,exampleStory:{templateArgsMap:O,cssArgsMap:U}}},render:e=>o.jsx(Q,{styles:e.cckExampleCssVariables,children:o.jsx(y,{cckExampleArgs:e.cckExampleArgs})})},Q=t.div`
  ${({styles:e})=>i`
    ${e}
  `}
`,Y={[c.FramesX]:{size:"md"},[c.CocoKits]:{size:"md"}},H={[c.FramesX]:{"--checkbox-group-column-color":"var(--colors-gray-300)","--checkbox-group-column-font-family":"var(--font-family)"},[c.CocoKits]:{"--checkbox-group-column-color":"var(--color-palette-gray-800)","--checkbox-group-column-font-family":"Inter"}},J=[{language:"tsx",filename:"CheckboxGroupRow.styled.tsx",code:`
import styled from 'styled-components';
...
`},{language:"scss",filename:"global.scss",code:`
      ...
      :root {--checkbox-group-column-color: var(--colors-gray-300);
        --checkbox-group-column-font-family: var(--font-family);
      }`,visibleConditions:[e=>e.id===c.FramesX]}],Z=t.span`
  color: var(--checkbox-group-column-color);
  font-style: italic;
  font-family: var(--checkbox-group-column-font-family);
`,ee=t.div`
  ...
  gap: 12px;
  margin-top: 10px;
`,m={Label:Z,CheckboxGroup:ee};function f(e){return o.jsxs("div",{children:[o.jsx(m.Label,{children:"Favorite food"}),o.jsxs(m.CheckboxGroup,{children:[o.jsx(r,{size:e.cckExampleArgs.size,value:1,children:"Pizza"}),o.jsx(r,{size:e.cckExampleArgs.size,value:2,children:"Pasta"}),o.jsx(r,{size:e.cckExampleArgs.size,value:3,children:"Fruits"})]})]})}f.__docgenInfo={description:"",methods:[],displayName:"CheckboxGroupRow",props:{cckExampleArgs:{required:!0,tsType:{name:"ExampleArgs"},description:""}}};const Re={name:"Checkbox Group Row",parameters:{cckAddon:{renderConditions:[s("Examples")],source:J,exampleStory:{templateArgsMap:Y,cssArgsMap:H}}},render:e=>o.jsx(oe,{styles:e.cckExampleCssVariables,children:o.jsx(f,{cckExampleArgs:e.cckExampleArgs})})},oe=t.div`
  ${({styles:e})=>i`
    ${e}
  `}
...
`,x={Container:xe,Box:pe};function S(e){return o.jsxs(x.Container,{children:[o.jsxs(x.Box,{children:[o.jsx(r,{value:1,children:"Leave at Door"}),o.jsx(k,{icon:b.info,size:e.cckExampleArgs.IconSize})]}),o.jsxs(x.Box,{children:[o.jsx(r,{value:2,children:"Call on Arrival"}),o.jsx(k,{icon:b.info,size:e.cckExampleArgs.IconSize})]})]})}S.__docgenInfo={description:"",methods:[],displayName:"CheckboxBoxSelectionInfo",props:{cckExampleArgs:{required:!0,tsType:{name:"ExampleArgs"},description:""}}};const Fe={name:"Checkbox Box Selection Info",parameters:{cckAddon:{renderConditions:[s("Examples")],source:de,exampleStory:{templateArgsMap:ie,cssArgsMap:le}}},render:e=>o.jsx(ke,{styles:e.cckExampleCssVariables,children:o.jsx(S,{cckExampleArgs:e.cckExampleArgs})})},ke=t.div`
  ${({styles:e})=>i`
    ${e}
  `}
`,Me={component:r,title:"UI Components/Checkbox",parameters:{docs:{description:{component:[T].join(`
`)}},cckAddon:{componentName:"checkbox"}}},Pe=["Default","Size","Color","CheckboxLabelThroughStory","CheckboxLabelLinkStory","CheckboxGroupColumnStory","CheckboxGroupRowStory","CheckboxBoxSelectionStory","CheckboxBoxSelectionInfoStory"];export{Fe as CheckboxBoxSelectionInfoStory,_e as CheckboxBoxSelectionStory,we as CheckboxGroupColumnStory,Re as CheckboxGroupRowStory,Te as CheckboxLabelLinkStory,Ge as CheckboxLabelThroughStory,$e as Color,je as Default,Be as Size,Pe as __namedExportsOrder,Me as default};
