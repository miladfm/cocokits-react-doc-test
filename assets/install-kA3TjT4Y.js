import{j as e,M as x}from"./DocsRenderer-CFRXHY34-DnFIM2bJ.js";import{useMDXComponents as m}from"./index-Ch4n-_Zu.js";import{l as a}from"./index-CVIK8CIp.js";import{M as u,a as s,b as j}from"./mdx-page-with-theme-section-BPd9EgOg.js";import"./index-C33_amOP.js";import"./react-18-B-IeCXFN.js";import{c,b as i}from"./markdown.util-CPD1LGoI.js";import"./iframe-C_FjfnNR.js";import"./index-Cghhjyi9.js";import"./index-DrFu-skq.js";import"./preview-DfOC2OG8.js";const g=[{id:"step-1-install-packages",name:"Step 1"},{id:"step-2-provide-theme-configuration",name:"Step 2"},{id:"step-3-add-component-styles",name:"Step 3"},{id:"step-4-apply-theme-modes",name:"Step 4"},{id:"step-5-basic-usage-of-components",name:"Step 5"},{id:"step-6-use-tokens-in-your-component-styles",name:"Step 6"}];function f(n){const o=`html
<html class="${Object.entries(n.selectedModes).map(([d,r])=>`cck-theme-${n.id}__${d}--${r}`).join(" ")}">
...
</html>
  `;return c(o)}function y(n){const o=`html
<html data-cck-theme="${Object.entries(n.selectedModes).map(([d,r])=>`${n.id}__${d}--${r}`).join(" ")}">
...
</html>
  `;return c(o)}function k(n){const t=n.id==="frames-x"?"sizing":"brand-color-1",o=n.selectedModes[t];return`
For example, to set the ${i(o)} mode from ${i(t)}:
  - **Collection Name:** ${i(t)}
  - **Mode Name:** ${i(o)}
  - **CSS Class:** ${i(`cck-theme-${n.id}__${t}--${o}`)}
    `}function h(n){return e.jsx("table",{className:"collection-modes-selector-table",children:e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("th",{children:"Collection Name"}),e.jsx("th",{children:"Mode Names"}),e.jsx("th",{children:"Selectors"})]}),Object.entries(n.tokenDictionary.collectionModeNames).map(([o,d])=>d.map((r,p)=>e.jsxs("tr",{children:[p===0&&e.jsx("td",{rowSpan:d.length,className:"collection-modes-selector-table__header-cell",children:o}),e.jsx("td",{children:r.name}),e.jsx("td",{children:e.jsxs("ul",{children:[e.jsx("li",{children:e.jsxs("code",{children:[".cck-theme-",n.id,"__",o,"--",r.name]})}),e.jsx("li",{children:e.jsxs("code",{children:["[data-cck-theme*='",n.id,"__",o,"--",r.name,"']"]})})]})})]},`${o}-${r.name}`)))]})})}h.__docgenInfo={description:"",methods:[],displayName:"getStep4CollectionModesTable",props:{id:{required:!0,tsType:{name:"ThemeId"},description:""},displayName:{required:!0,tsType:{name:"string"},description:""},description:{required:!0,tsType:{name:"string"},description:""},tokenDictionary:{required:!0,tsType:{name:"TokenDictionary"},description:""},themeConfig:{required:!0,tsType:{name:"ThemeConfig"},description:""},defaultSelectedModes:{required:!0,tsType:{name:"Record",elements:[{name:"string"},{name:"string"}],raw:"Record<string, string>"},description:""},iconPaths:{required:!0,tsType:{name:"Record",elements:[{name:"ColorMode"},{name:"string"}],raw:"Record<ColorMode, string>"},description:""},colorModeTokenCollectionMode:{required:!0,tsType:{name:"Record",elements:[{name:"ColorMode"},{name:"Record",elements:[{name:"string"},{name:"string"}],raw:"Record<string, string>"}],raw:"Record<ColorMode, Record<string, string>>"},description:`Handles the theme switch in Storybook by updating the CCK theme mode.\r
\r
...
It includes information on prerequisites, installation, and how to display a sample component in your application to verify your setup.`]}),e.jsx(t.h2,{id:"before-you-start",children:"Before you start"}),e.jsx(t.p,{children:"Make sure you select the theme that you want to install along with your preferred mode from each collection."}),e.jsx(t.hr,{}),e.jsx(t.h2,{id:"step-1-install-packages",children:"Step 1: Install Packages"}),e.jsx(s,{fn:o=>`Install the ${i("CocoKits")} React components and the ${i(o.displayName)} theme`}),e.jsx(s,{fn:o=>e.jsx(j,{codeTabs:{npm:`npm i @cocokits/react-components @cocokits/theme-${o.id}`,yarn:`yarn add @cocokits/react-components @cocokits/theme-${o.id}`,pnpm:`pnpm add @cocokits/react-components @cocokits/theme-${o.id}`}})}),e.jsx(t.hr,{}),e.jsx(t.h2,{id:"step-2-provide-theme-configuration",children:"Step 2: Provide Theme Configuration"}),e.jsx(s,{fn:o=>`Provide the ${i(o.displayName)} theme configuration in the root of your application.`}),e.jsx(t.p,{children:e.jsx(t.strong,{children:"App.tsx"})}),e.jsx(s,{fn:o=>c(`tsx
...
You can find all tokens with their names and values in the `,e.jsx(t.code,{children:"Theme Config / Tokens"})," page of the documentation."]})]})]})}function E(n={}){const{wrapper:t}={...m(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(l,{...n})}):l(n)}export{E as default};
