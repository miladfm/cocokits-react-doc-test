import{j as e,M as c}from"./DocsRenderer-CFRXHY34-DYLQIu6l.js";import{useMDXComponents as n}from"./index-Ch4n-_Zu.js";import"./index-BuDfaz5G.js";import{M as o}from"./mdx-page-with-theme-section-DJcXbP4T.js";import"./index-C33_amOP.js";import"./react-18-B-IeCXFN.js";import"./iframe-BGTQkvIC.js";import"./index-Cghhjyi9.js";import"./index-DrFu-skq.js";import"./preview-BRjlhpHT.js";const i=[{id:"selection_scrolllocker",name:"ScrollLocker"}];function r(s){const l={code:"code",h2:"h2",h3:"h3",h4:"h4",h5:"h5",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...n(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(c,{title:"Utils/Scroll"}),`
...
the body width, particularly when the content resizes.`]}),e.jsx(l.h5,{id:"parameters-1",children:"Parameters"}),e.jsx("div",{className:"arg-type-table-wrapper",children:e.jsxs("table",{className:"arg-type-table arg-type-table--full-width",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Parameter"}),e.jsx("th",{children:"Type"}),e.jsx("th",{children:"Default value"}),e.jsx("th",{className:"description-column",children:"Description"})]})}),e.jsx("tbody",{children:e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(l.p,{children:e.jsx(l.code,{children:"hideScrollbar"})})}),e.jsx("td",{children:e.jsx(l.p,{children:e.jsx(l.code,{children:"boolean"})})}),e.jsx("td",{children:e.jsx(l.p,{children:e.jsx(l.code,{children:"false"})})}),e.jsxs("td",{children:[e.jsx(l.p,{children:"Whether to hide the scrollbar when locking."}),e.jsxs(l.ul,{children:[`
...
`})}),e.jsx(l.p,{children:"Removes a previously added scroll lock change listener."}),e.jsx(l.h5,{id:"parameters-2",children:"Parameters"}),e.jsx("div",{className:"arg-type-table-wrapper",children:e.jsxs("table",{className:"arg-type-table arg-type-table--full-width",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Parameter"}),e.jsx("th",{children:"Type"}),e.jsx("th",{className:"description-column",children:"Description"})]})}),e.jsx("tbody",{children:e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(l.p,{children:e.jsx(l.code,{children:"callback"})})}),e.jsx("td",{children:e.jsx(l.p,{children:e.jsx(l.code,{children:"(isLock: boolean) => void"})})}),e.jsx("td",{children:e.jsx(l.p,{children:"The listener function to be removed."})})]})})]})}),e.jsx(l.h5,{id:"returns-3",children:"Returns"}),e.jsx(l.p,{children:e.jsx(l.code,{children:"void"})}),e.jsx(l.h5,{id:"example-4",children:"Example"}),e.jsx(l.pre,{children:e.jsx(l.code,{className:"language-typescript",children:`const locker = ScrollLocker.globalInstance();\r
...
`})})]})]})]})}function m(s={}){const{wrapper:l}={...n(),...s.components};return l?e.jsx(l,{...s,children:e.jsx(r,{...s})}):r(s)}export{m as default,i as tocItems};
