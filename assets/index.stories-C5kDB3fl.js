import{p as t}from"./index-DNsOJRlX.js";import{j as o}from"./DocsRenderer-CFRXHY34-B0Fvrjtp.js";import"./mdx-page-with-theme-section-BwlOJl6T.js";import{t as s,c as l,s as p,w as m,e as c,x as a}from"./control.config-B1b8V5tA.js";import"./index-C33_amOP.js";import{r as d}from"./preview.base-fh5Wvfmp.js";import"./react-18-B-IeCXFN.js";import"./preview-D09guH6v.js";import"./iframe-CSwqnnwm.js";import"./index-Cghhjyi9.js";import"./index-DrFu-skq.js";import"./addon.model-Bxedznpl.js";const u=`The \`SvgIcon\` from \`@cocokits\` allows for the dynamic embedding of SVG icons within your React applications.\r
\r
\r
#### Features:\r
\r
...
- **Theme Integration:** Select an SVG icon from your theme, and the component handles the rest, ensuring it aligns perfectly with your application's look and feel.`,b={name:"Default",parameters:{docs:{description:{story:"Shows the default example with no additional configurations, providing an interactive example in its most basic form."}},cckAddon:{renderConditions:[c("Overview")],source:[{filename:"Source Code",language:"tsx",code:`
          ...
          `}],hasControl:!0,controls:[s(),l(),p(),m("heartFill")]}},render:e=>o.jsx(t,{...d(e),icon:e.cckIcons[e.cckControl.icon]})},O={name:"Size",parameters:{docs:{description:{story:"The size is adjustable to suit different design needs and screen dimensions, improving both aesthetics and usability."}},cckAddon:{renderConditions:[a("size"),c("Overview")],singleControls:["type"],source:[{filename:"Source Code",language:"tsx",code:`
            ...
            `}],controls:[s()]}},render:e=>{var n;return o.jsx(o.Fragment,{children:(n=e.cckControl.themeComponentConfig.color)==null?void 0:n.values.map((i,r)=>o.jsx(t,{type:e.cckControl.type,color:i,icon:e.cckIcons.heartFill},r))})}},j={component:t,title:"UI Components/SvgIcon",parameters:{docs:{description:{component:[u].join(`
`)}},cckAddon:{componentName:"svgIcon"}}},F=["Default","Size","Color"];export{T as Color,b as Default,O as Size,F as __namedExportsOrder,j as default};
