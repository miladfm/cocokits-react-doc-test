import{B as n,j as a,P as e,I as d,y as r,Q as l}from"./doc-page-DIWHsT11.js";import{ag as o}from"./chunk-NUUEMKO5-CIFNfSn7.js";import"./mdx-page-with-theme-section-BKb6O5wa.js";import{r as s,C as k,t as m,c as A,s as h,O as E,P as b,a as I,d as T,x as u}from"./control.config-JHtxwN74.js";import"./index-qVDZzPEr.js";import{r as v}from"./preview.base-CgZRDwuM.js";import"./react-18-CVVedRj1.js";import"./index-DM35cTar.js";import"./menu-item-CcDQt4Mk.js";import"./toggle-Dh65CaRN.js";import"./iframe-CYvzaISi.js";import"../sb-preview/runtime.js";import"./index-D2o5vtt7.js";import"./index-DrFu-skq.js";import"./addon.model-Bxedznpl.js";const z=`
...
`,w={info:z,trash:j},H="A button in the context of UI is an interactive element that allows users to perform an action.\r\n\r\nThe `Button` from `@cocokits` provides a flexible, customizable button element within React applications. This component is compatible with multiple design system themes and allows for various configurations, including different button types, colors, and sizes.\r\n",Et={name:"Default",parameters:{docs:{description:{story:"Shows the default example with no additional configurations, providing an interactive example in its most basic form."}},cckAddon:{source:[{filename:"Source Code",language:"tsx",code:`
          ...
          `}],renderConditions:[s("Overview")],hasControl:!0,controls:[k("Button"),m(),A(),h(),E("none"),b("heartFill"),I(),T()]}},args:{},render:t=>o.jsxs(n,{...v(t),disabled:t.cckControl.disabled,children:[t.cckControl.leftIcon!=="none"&&o.jsx(a,{icon:t.cckIcons[t.cckControl.leftIcon]}),t.cckControl.text,t.cckControl.rightIcon!=="none"&&o.jsx(a,{icon:t.cckIcons[t.cckControl.rightIcon]})]})},bt={name:"Type",parameters:{docs:{description:{story:"Displays variations in appearance and functionality, demonstrating how different types can be used to create unique button styles."}},cckAddon:{renderConditions:[u("type"),s("Overview")],source:[{filename:"Source Code",language:"tsx",code:`
          ...
          `}],controls:[m()]}},render:t=>{var c;return o.jsx(o.Fragment,{children:(c=t.cckControl.themeComponentConfig.color)==null?void 0:c.values.map((i,p)=>o.jsx(n,{type:t.cckControl.type,color:i,children:i},p))})}},M={[e.FramesX]:{},[e.CocoKits]:{}},V={[e.FramesX]:{},[e.CocoKits]:{}},$=[{language:"tsx",filename:"BackButton.tsx",code:`
...
`}];function x(t){return o.jsxs(n,{type:t.cckExampleArgs.buttonType,children:[o.jsx(a,{icon:d.link}),o.jsx("span",{children:"Copy Link"})]})}x.__docgenInfo={description:"",methods:[],displayName:"CopyLinkButton",props:{cckExampleArgs:{required:!0,tsType:{name:"ExampleArgs"},description:""}}};const zt={name:"Copy Link Button",parameters:{cckAddon:{renderConditions:[s("Examples")],source:O,exampleStory:{templateArgsMap:R,cssArgsMap:L}}},render:t=>o.jsx(F,{styles:t.cckExampleCssVariables,children:o.jsx(x,{cckExampleArgs:t.cckExampleArgs})})},F=r.div`
  ${({styles:t})=>l`
    ${t}
  `}
`,N={[e.FramesX]:{buttonType:"default",buttonColor:"danger"},[e.CocoKits]:{buttonType:"primary",buttonColor:"error"}},D={[e.FramesX]:{},[e.CocoKits]:{}},K=[{language:"tsx",filename:"DeleteButton.tsx",code:`
...
`}];function f(t){return o.jsxs(n,{type:t.cckExampleArgs.buttonType,color:t.cckExampleArgs.buttonColor,children:[o.jsx("span",{children:"Show More"}),o.jsx(a,{icon:d.arrowHeadDown})]})}f.__docgenInfo={description:"",methods:[],displayName:"ShowMoreButton",props:{cckExampleArgs:{required:!0,tsType:{name:"ExampleArgs"},description:""}}};const Ht={name:"Volume Button",parameters:{cckAddon:{renderConditions:[s("Examples")],source:Y,exampleStory:{templateArgsMap:Z,cssArgsMap:W}}},render:t=>o.jsx(Q,{styles:t.cckExampleCssVariables,children:o.jsx(f,{cckExampleArgs:t.cckExampleArgs})})},Q=r.div`
  ${({styles:t})=>l`
    ${t}
  `}
...
`}];function g(t){return o.jsxs(et,{children:[o.jsx(n,{type:t.cckExampleArgs.firstButtonType,size:t.cckExampleArgs.firstButtonSize,color:t.cckExampleArgs.firstButtonColor,children:"Cancel"}),o.jsx(n,{type:t.cckExampleArgs.secondButtonType,size:t.cckExampleArgs.secondButtonSize,color:t.cckExampleArgs.secondButtonColor,children:"Confirm"})]})}const et=r.div`
  display: flex;
  gap: 12px;
`;g.__docgenInfo={description:"",methods:[],displayName:"StackHorizontalButton",props:{cckExampleArgs:{required:!0,tsType:{name:"ExampleArgs"},description:""}}};const Mt={name:"Volume Button",parameters:{cckAddon:{renderConditions:[s("Examples")],source:ot,exampleStory:{templateArgsMap:J,cssArgsMap:tt}}},render:t=>o.jsx(nt,{styles:t.cckExampleCssVariables,children:o.jsx(g,{cckExampleArgs:t.cckExampleArgs})})},nt=r.div`
  ${({styles:t})=>l`
    ${t}
  `}
...
`;S.__docgenInfo={description:"",methods:[],displayName:"StackVerticalButton",props:{cckExampleArgs:{required:!0,tsType:{name:"ExampleArgs"},description:""}}};const Vt={name:"Volume Button",parameters:{cckAddon:{renderConditions:[s("Examples")],source:ct,exampleStory:{templateArgsMap:st,cssArgsMap:rt}}},render:t=>o.jsx(at,{styles:t.cckExampleCssVariables,children:o.jsx(S,{cckExampleArgs:t.cckExampleArgs})})},at=r.div`
  ${({styles:t})=>l`
    ${t}
  `}
`,$t={component:n,title:"UI Components/Button",decorators:[],parameters:{docs:{description:{component:[H].join(`
`)}},cckAddon:{componentName:"button"}},argTypes:{}},_t=["Default","Type","Size","Color","BackButtonStory","CopyLinkButtonStory","DeleteButtonStory","AddNewButtonStory","ShowMoreButtonStory","StackHorizontalButtonStory","StackVerticalButtonStory"];export{wt as AddNewButtonStory,vt as BackButtonStory,Tt as Color,zt as CopyLinkButtonStory,Et as Default,jt as DeleteButtonStory,Ht as ShowMoreButtonStory,It as Size,Mt as StackHorizontalButtonStory,Vt as StackVerticalButtonStory,bt as Type,_t as __namedExportsOrder,$t as default};
