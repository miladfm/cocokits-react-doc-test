...
`,e.jsx(r.li,{}),`
`]}),e.jsx(r.pre,{children:e.jsx(r.code,{className:"language-typescript",children:`const { promise, resolve, reject } = lazyPromise<number>();\r
\r
